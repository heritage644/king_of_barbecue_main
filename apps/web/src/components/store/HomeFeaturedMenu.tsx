...
export function HomeFeaturedMenu({
  ...
  return (
    <section id="featured" className="mx-auto w-full max-w-7xl space-y-5 px-4 py-6 sm:px-6 lg:px-8">
      {/* Header */}
      ...
      {/* Category Pills Rail with Hidden Scrollbar */}
      {tabs.length > 1 ? (
        <div
          ref={pillsRef}
          role="tablist"
          ...
          className="-mx-4 flex items-center gap-2 overflow-x-auto px-4 pb-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden sm:mx-0 sm:flex-wrap sm:overflow-visible sm:px-0"
        >
          {tabs.map((tab) => {
